...
export const RECEITAS = [
  ...
  },
  {
    ...
    ingredientes: ["1 - 1 ovo",
      "2 - uma clara",
      "3 - duas colheres de sopa de goma de tapioca",
      "4 - uma pitada de sal."
    ],
    preparo: [
  ...
  },
  {
    ...
    ingredientes: ["1 - ovo",
      "2 - 2 colheres de sopa farinha de amêndoas ou farinha de amendoim",
      "3 - 1 colher de sopa farinha de coco",
      "4 - 1/2 colher de chá fermento em pó (opcional)",
      "5 - 1 colher de sopa água", 
      "6 - sal a gosto",
      "7 - gordura para untar (azeite, óleo de coco ou manteiga)",
    ],
  ...
  },
  {
    ...
    ingredientes: ["1 - 4 ovos",
      "2 - 4 colheres de sopa óleo de coco",
      "3 - 5 colheres de sopa xilitol ou açúcar de coco",
      "4 - 1 xícara cacau em pó",
      "5 - 1 xícara água",
      "6 - 100 g farinha de amêndoas", 
      "7 - 1 colher fermento em pó",
    ],
  ...
  },
  {
    ...
    ingredientes: ["1 - uma banana prata;",
      "2 - duas colheres de sopa de farinha de aveia;",
      "3 - 1 ovo;",
      "4 - duas colheres de chá de açúcar de coco.",
    ],
  ...
  },
  {
    ...
    ingredientes: ["1 - 1 ovo;",
      "2 - 1 colher sopa de cacau em pó;",
      "3 - 1 colher sopa de farelo de aveia;",
      "4 - 1 banana nanica madura;",
  ...
  },
  {
    ...
    ingredientes: ["1 - 1 xícara de chá de mamão descascado e picado;",
      "2 - 1 xícara de chá de leite desnatado gelado;",
      "3 - 1 colher de sopa de farelo de aveia;",
      "4 - 1 colher de mel ou agave.",
    ],
